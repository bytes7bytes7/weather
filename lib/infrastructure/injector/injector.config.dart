...
import '../../application/blocs/auth/auth_bloc.dart' as _i19;
import '../../application/blocs/forecast/forecast_bloc.dart' as _i21;
...
import '../../domain/services/forecast_service.dart' as _i20;
...
_i1.GetIt init(
  ...
  gh.factory<_i19.AuthBloc>(() => _i19.AuthBloc(gh<_i5.AuthService>()));
  gh.singleton<_i20.ForecastService>(_i20.ForecastService(
    gh<_i8.LocationRepository>(),
    gh<_i6.ForecastRepository>(),
  ));
  gh.factory<_i21.ForecastBloc>(
      () => _i21.ForecastBloc(gh<_i20.ForecastService>()));
  return getIt;
}
